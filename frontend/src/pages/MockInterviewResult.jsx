  ...
  useEffect(() => {
    ...
    style.innerHTML = `
      ...
      .feedback-box {
        ...
        font-family: 'Segoe UI', sans-serif; /* Ensuring readability vs monospace */
        font-size: 1rem;
        line-height: 1.7;
        color: #334155;
        ...
        <div className="row justify-content-center">
          <div className="col-lg-10">
            ...
            <div className="custom-card p-5 animate-entrance" style={{animationDelay: '0.1s'}}>
              ...
              <h5 style={{color: '#002147', fontWeight: '700', marginBottom: '1.5rem'}}>Comprehensive Feedback</h5>
