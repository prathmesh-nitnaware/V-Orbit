...
export default function ResumeScorer() {
  ...
  useEffect(() => {
    ...
    style.innerHTML = `
      ...
      .progress-fill {
        height: 100%;
        background-color: var(--color-primary); /* Navy bar */
        border-radius: 5px;
        animation: growBar 1s ease forwards;
      }

      .skill-tag {
        background-color: #FFE4E1; /* Light red for missing */
        color: #8B0000;
          ...
          <div className="col-lg-10">
            ...
            {result && (
              <div className="custom-card p-5 mt-4 animate-entrance" style={{animationDelay: '0.2s'}}>
                <h4 style={{color: '#002147', fontWeight: '700', marginBottom: '2rem'}}>Analysis Result</h4>
                ...
                <div className="row">
                  ...
                  <div className="col-md-4 text-center mb-4 mb-md-0 border-end">
                    ...
                    <div className="mt-4 px-4">
                      <div className="d-flex justify-content-between mb-1">
                        ...
                        <span className="small fw-bold">{result.jdMatchPercentage}%</span>
                      </div>
                  ...
                  <div className="col-md-8 ps-md-5">
                    ...
                    {/* Missing Skills */}
                    <div className="mb-4">
                      <h6 className="form-label text-danger">Missing Keywords</h6>
                      <div>
                        {result.missingSkills.map((skill, i) => (
                          <span key={i} className="skill-tag">{skill}</span>
                        ))}
                        {result.missingSkills.length === 0 && <span className="text-success small fw-bold">No critical skills missing!</span>}
                      </div>
                    </div>

                    {/* Recommendations */}
                    <div>
                      <h6 className="form-label" style={{color: '#D4AF37'}}>AI Recommendations</h6>
                      <div className="mt-2">
